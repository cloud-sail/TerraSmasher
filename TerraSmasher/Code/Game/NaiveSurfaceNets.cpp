#include "Game/NaiveSurfaceNets.hpp"
...
NaiveSurfaceNets::NaiveSurfaceNets()
{
...
void NaiveSurfaceNets::RegenerateMesh(IntGrid3 const& grid, std::vector<float> const& sdfValues, float blockyBlendFactor /*= 0.f*/)
{
	m_isReady = false;
...
void NaiveSurfaceNets::ResetData()
{
...
void NaiveSurfaceNets::EstimateIsosurfaceVertexAndNormal()
{
...
void NaiveSurfaceNets::BuildMeshQuads()
{
...
void NaiveSurfaceNets::TryBuildQuad(int p1, int p2, int strideAxisB, int strideAxisC)
{
	//int p1 = index1D;
...
STATIC Vec3 NaiveSurfaceNets::GetEdgeIntersectionsCentroid(int cubeIndex, float* cornerDensities, float isosurfaceValue)
{
...
STATIC Vec3 NaiveSurfaceNets::GetSdfGradient(Vec3 const& s, float* d)
{
